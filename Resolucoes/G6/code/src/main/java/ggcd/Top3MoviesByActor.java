...
public class Top3MoviesByActor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Movie Actor
        JavaPairRDD<String, String> movies_by_actor = sc.textFile("hdfs://namenode:9000/input/title.principals.tsv.bz2")
                .map(l -> l.split("\t+"))
        ...
        // Movie Rating
        JavaPairRDD<String, Float> ratings = sc.textFile("hdfs://namenode:9000/input/title.ratings.tsv.bz2")
                .map(l -> l.split("\t+"))
                .filter(l -> !l[0].equals("tconst"))
