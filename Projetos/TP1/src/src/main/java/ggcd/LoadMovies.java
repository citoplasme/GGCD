...
public class LoadMovies {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        HTableDescriptor t = new HTableDescriptor(TableName.valueOf("movies_tp1"));
        ...
        job.getConfiguration().set(TableOutputFormat.OUTPUT_TABLE, "movies_tp1");
        ...
        TextInputFormat.setInputPaths(job2, "hdfs://namenode:9000/input/title.ratings.tsv");

        job2.setOutputFormatClass(TableOutputFormat.class);

        job2.getConfiguration().set(TableOutputFormat.OUTPUT_TABLE, "movies_tp1");
