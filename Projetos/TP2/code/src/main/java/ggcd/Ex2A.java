...
// Top10: Calcule o top 10 dos atores que participaram em mais títulos diferentes.
public class Ex2A {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairRDD<String, Integer> movies_by_actor = sc.textFile("hdfs://namenode:9000/input/title.principals.tsv")
            .map(l -> l.split("\t+"))
